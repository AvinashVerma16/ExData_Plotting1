...
with(data1,plot(data1$Sub_metering_1, type = "l", xlab = "", xaxt = "n", ylab = "Energy sub metering", col = "black"))
with(data1,lines(data1$Sub_metering_2, type = "l", col = "red"))
with(data1,lines(data1$Sub_metering_3, type = "l", col = "blue"))
